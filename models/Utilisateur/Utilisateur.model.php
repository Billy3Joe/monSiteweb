...
class UtilisateurManager extends MainManager {
  ...
  private function getPasswordUser($login) {
    ...
    // Vérifie si la requête a renvoyé quelque chose avant d'accéder à l'indice 'password'
    if ($resultat !== false) {
        return $resultat['password'];
    }

    // Si aucune ligne n'est trouvée, retournez quelque chose de significatif (peut-être false ou une chaîne vide)
    return false;
}
